...
tags: [DFIR, Memory Forensics, C++, Linux]
category: Tools
image: /covers/memnixfs.webp
repoUrl: https://github.com/MemNixFS/MemNixFS
pinned: true
contributors:
  - name: Youssef Ayman
    url: https://github.com/ELJoOker2004
draft: false
---
...
See the [CLI reference](https://github.com/MemNixFS/MemNixFS/blob/main/docs/cli-reference.md) and the [feature docs](https://github.com/MemNixFS/MemNixFS/blob/main/docs/README.md) for
the full path map.
...
Grab a build (or [build from source](https://github.com/MemNixFS/MemNixFS/blob/main/docs/building.md)), then:
...
see [`src/api/lmpfs.h`](https://github.com/MemNixFS/MemNixFS/blob/main/src/api/lmpfs.h)) — the CLI is just one consumer, so any language
...
**Linux** uses FUSE for the mount backend; see the [build guide](https://github.com/MemNixFS/MemNixFS/blob/main/docs/building.md):
...
- **[Documentation wiki](https://github.com/MemNixFS/MemNixFS/blob/main/docs/README.md)** — architecture, every feature explained,
  recipes, troubleshooting, glossary.
- **[Overview](https://github.com/MemNixFS/MemNixFS/blob/main/docs/overview.md)** · **[CLI reference](https://github.com/MemNixFS/MemNixFS/blob/main/docs/cli-reference.md)** ·
  **[Build guide](https://github.com/MemNixFS/MemNixFS/blob/main/docs/building.md)**
